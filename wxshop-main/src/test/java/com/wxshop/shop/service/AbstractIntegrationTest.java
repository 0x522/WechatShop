...
import static com.wxshop.shop.service.TelVerificationServiceTest.VALID_PARAMETER;
import static com.wxshop.shop.service.TelVerificationServiceTest.VALID_PARAMETER_CODE;
...
public class AbstractIntegrationTest {
    ...
    public UserLoginResponse loginAndGetCookie() throws JsonProcessingException {
        ...
        String cookie = getSessionIdFromSetCookie(setCookie.stream().filter(jsessionId -> jsessionId.contains("JSESSIONID"))
                .findFirst()
                .get());
